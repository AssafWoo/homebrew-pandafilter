class Pandafilter < Formula
  ...
  on_arm do
    url "https://github.com/AssafWoo/PandaFilter/releases/download/v1.3.15/panda-macos-arm64.tar.gz"
    sha256 "c531221403265b30edbdcba5705b98e141972805657b559f797e0bfdbfb244d5"
  end

  on_intel do
    url "https://github.com/AssafWoo/PandaFilter/releases/download/v1.3.15/panda-macos-x86_64.tar.gz"
    sha256 "5a479c84279cd85e6ebcd0065daa50139aa65450dd27af9eea0789ba5452d971"
  end
