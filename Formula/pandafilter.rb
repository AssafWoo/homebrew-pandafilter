class Pandafilter < Formula
  ...
  on_arm do
    url "https://github.com/AssafWoo/PandaFilter/releases/download/v1.3.10/panda-macos-arm64.tar.gz"
    sha256 "12e56c1d1f70a3a71c83c67b6ca5c4a4c257a63421b5513480db654674380fe8"
  end

  on_intel do
    url "https://github.com/AssafWoo/PandaFilter/releases/download/v1.3.10/panda-macos-x86_64.tar.gz"
    sha256 "4b8da4cd87ce2bc570e18f596039e5f6f3916da23ccf01d7fcb1c4a7d4a7fde7"
  end
